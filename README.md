...
You view the project will be launched shortly.
...
- Strengthen skills in **Go, TypeScript, React, and Cloud Hosting**, with an emphasis on concurrency, networking, and state management
...
- Track basic analytics about our users

## Design
A design document will be released shortly.

We touch on our system design, frontend state management, and deep-dive into the engine.
