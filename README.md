...
**Zugzwang** is a self-led, senior project: a real-time online chess platform featuring a Go-based backend, HTMX, and a custom-built chess engine.
...
## Design
A design document will be created, going into depth about the design of the project, focusing on the backend and engine.
